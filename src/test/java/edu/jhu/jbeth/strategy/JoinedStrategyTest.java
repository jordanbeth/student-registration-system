...
public class JoinedStrategyTest {
    ...
    private static final Logger logger = Logger.getLogger(JoinedStrategyTest.class);

    private static final String PERSISTANCE_UNIT_NAME = "StudentRegistrationSystem_Joined";
